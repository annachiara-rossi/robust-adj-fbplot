...
plot( median.fData( gauss_FD, ASG = TRUE  ), col = 'yellow', lwd = 2, lty = 1, add = TRUE )
...
quartz()
par( mfrow = c( 1, 3 ) )
plot( as.fData.fPC( Eigen.C ), xlab = 'time', ylab = '', main = 'Sample eigenfunctions' )
plot( as.fData.fPC( Eigen.CS ), xlab = 'time', ylab = '', main = 'Spherical eigenfunctions' )
