...
fD.L2 = fData2( t( CanadianWeather$dailyAv[,,1] ), geometry.L2 )
...
fD.H1 = fData2( t( CanadianWeather$dailyAv[ , , 1 ] ), geometry.L2 )

# H2
geometry.H2 = Geometry( fourier.basis, space = 'H2' )
fD.H2 = fData2( t( CanadianWeather$dailyAv[ , , 1 ] ), geometry.H2  )
...
fD.PCA.L2 = fData2( t( CanadianWeather$dailyAv[ , , 1 ] ), geometry.fPC.L2 )
...
fD.PCA.H1 = fData2( t( CanadianWeather$dailyAv[ , , 1 ] ), geometry.fPC.H1 )
...
fD.PCA.H2 = fData2( t( CanadianWeather$dailyAv[ , , 1 ] ), geometry.fPC.H2 )
...
quartz()
plot( fData2( sin( 2 * pi * timeStr$grid ), geometry.L2 ) - 1, col = 'black' )
