...
fD.L2  = fData2( fourier.basis$elements, geometry = geometry.L2 )
fD.sH1 = fData2( fourier.basis$elements, geometry = geometry.sH1 )
fD.H1  = fData2( fourier.basis$elements, geometry = geometry.H1 )
fD.sH2 = fData2( fourier.basis$elements, geometry = geometry.sH2 )
fD.H2  = fData2( fourier.basis$elements, geometry = geometry.H2 )
...
fD.L2  = fData2( bspline.basis$elements, geometry = geometry.L2 )
# fD.sH1 = fData2( bspline.basis$elements, geometry = geometry.sH1 )
fD.H1  = fData2( bspline.basis$elements, geometry = geometry.H1 )
# fD.sH2 = fData2( bspline.basis$elements, geometry = geometry.sH2 )
fD.H2  = fData2( bspline.basis$elements, geometry = geometry.H2 )
