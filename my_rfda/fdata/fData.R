...
fData2 = function( data, geometry = NULL, basis = NULL, space = NULL )
{
  if( is.null( geometry ) )
  {
...
as.fData2 = function( coefficients, geometry )
{
...
"+.fData2" = function( fD, A )
{
  if( class( A ) == 'fData2' )
  {
    ...
    fD$coefficients = fD$coefficients + fData2( A, fD$geometry )$coefficients
